...
{
    public class PriorityTicketController : Controller
    {
        //public PrioridadTicket prioridadticket = new PrioridadTicket();
        public IPriorityTicketManager manager;
        /// <summary>
        /// Initializes a new instance of the <see cref="BranchController"/> class.
        /// </summary>
        /// <param name="_manager">The manager.</param>
        public PriorityTicketController(IPriorityTicketManager _manager)
        {
            manager = _manager;
        }

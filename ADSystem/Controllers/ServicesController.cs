...
namespace ADSystem.Controllers
{
    ...
    public class ServicesController : BaseController
    {
        ...
        [HttpPost]
        public ActionResult SaveAddService(string description, short? installation)
        {
            JsonMessenger jmResult = new JsonMessenger();
            ...
            try
            {
                ...
                else if (tServices.AddService(description, installation??0) > 0)
                {
                    jmResult.success = 1;
        ...
        [HttpPost]
        public ActionResult SaveUpdateService(int idService, string description, short? installation)
        {
            JsonMessenger jmResult = new JsonMessenger();
            ...
            try
            {
                ...
                tServices.UpdateService(idService, description, installation??0);

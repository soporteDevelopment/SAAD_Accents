...
namespace ADSystem.Controllers
{
    ...
    public class ProvidersController : BaseController
    {
        ...
        [HttpGet]
        public ActionResult GetProviderByTypeService(int idTipoServicio)
        {
            JsonMessenger jmResult = new JsonMessenger();
            ...
            try
            {
                jmResult.success = 1;
                jmResult.failure = 0;
                jmResult.oData = new { Providers = tProviders.GetProvidersByTypeService(idTipoServicio) };
            }
            catch (Exception ex)
            {
        ...
        public ActionResult SaveAddProvider(string company, string rsocial, string ncommerce, string domFiscal, string domEntrega, 
                                            ...
                                            string rfcMEX, string telephone, string regimenFiscal, bool? proveedorPedidosMedida,
                                            int? idTipoServicio)
        {
            ...
            try
            {
                ...
                oProveedor.RegimenFiscal = regimenFiscal;
                oProveedor.ProveedorPedidosMedida = proveedorPedidosMedida;
                oProveedor.idTipoServicio = idTipoServicio;

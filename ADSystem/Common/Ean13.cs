...
namespace ADSystem.Common
{
    public class Ean13
    {
        ...
        public Ean13(string _scPedido)
        {
            this._sCodePedido = _scPedido;
        }
        ...
        public void DrawEan13Barcode(System.Drawing.Graphics g, System.Drawing.Point pt)
        {
            ...
            sbTemp.AppendFormat(this._sCodePedido + this.ChecksumDigit);
            ...
            xPosition = xStart - g.MeasureString("00".Substring(0, 1), font).Width;
        ...
        {
            string sTemp = this._sCodePedido;
            int iSum = 0;
            int iDigit = 0;

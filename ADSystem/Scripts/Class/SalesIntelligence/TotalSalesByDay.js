angular.module("General")
    .controller('TotalSalesController', function (models, $scope, $http, $window, notify, $rootScope, $filter) {
        ...
        $scope.LoadSales = function () {
            ...
            $http({
                method: 'GET',
                url: '../../../SalesIntelligence/TotalSalesByDay',
                params: {
                    user: $scope.seller,
                    branch: $scope.branch,
        ...
        $scope.DownloadSales = function () {
            ...
            window.location = "/SalesIntelligence/TotalSalesByDayXLS?user=" + $scope.seller + "&branch=" + $scope.branch + "&startDate=" + startDate + "&endDate=" + endDate;
        };

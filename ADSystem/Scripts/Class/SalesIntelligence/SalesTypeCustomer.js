angular.module("General")
    .controller('SalesTypeCustomerController', function (models, $scope, $http, $window, notify, $rootScope, $filter) {
        ...
        $scope.LoadSales = function () {
            ...
            $http({
                method: 'GET',
                url: '../../../SalesIntelligence/SalesTypeCustomer',
                params: {
                    user: $scope.seller,
                    branch: $scope.branch,
        ...
        $scope.DownloadSales = function () {
            ...
            window.location = "/SalesIntelligence/TotalSalesXLS?user=" + $scope.seller + "&branch=" + $scope.branch + "&startDate=" + startDate + "&endDate=" + endDate;
        };

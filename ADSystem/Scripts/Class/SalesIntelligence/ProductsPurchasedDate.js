angular.module("General")
    .controller('ProductsPurchasedDateController', function (models, $scope, $http, $window, notify, $rootScope, $filter) {
        ...
        $scope.LoadSales = function () {
            ...
            $http({
                method: 'GET',
                url: '../../../SalesIntelligence/ProductsPurchasedDate',
                params: {
                }
            }).
                success(function (data, status, headers, config) {
                    ...
                    if (data.success == 1) {
                        if (data.oData.SalesProducts.length == 0) { notify('No se encontraron registros.', $rootScope.error); }
                        $scope.views = data.oData.SalesProducts;
        ...
        $scope.DownloadSales = function () {
            ...
            window.location = "/SalesIntelligence/ProductsPurchasedDateXLS";
        };

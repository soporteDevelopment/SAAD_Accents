...
namespace ADEntities.Models
{
    ...
    public partial class admDB_SAADDBEntities : DbContext
    {
        ...
        public virtual DbSet<tTipoMedida> tTipoMedida { get; set; }
        public virtual DbSet<tTextile> tTextiles { get; set; }
        public virtual DbSet<tServicioMedidasEstandar> tServicioMedidasEstandars { get; set; }
        public virtual DbSet<tEstatusPrecotizacion> tEstatusPrecotizacions { get; set; }
        public virtual DbSet<tEstatusServicio> tEstatusServicios { get; set; }
        public virtual DbSet<tHistEstatusPreCot> tHistEstatusPreCots { get; set; }
        public virtual DbSet<tHistEstatusServicio> tHistEstatusServicios { get; set; }
        public virtual DbSet<tPreCotDetalleTipoTela> tPreCotDetalleTipoTelas { get; set; }
        public virtual DbSet<tPreCotDetalleMedida> tPreCotDetalleMedidas { get; set; }
        public virtual DbSet<tRelCotPrecot> tRelCotPrecots { get; set; }
        public virtual DbSet<tPreCotDetalleProveedore> tPreCotDetalleProveedores { get; set; }
        public virtual DbSet<tPreCotProveedoresTela> tPreCotProveedoresTelas { get; set; }
        public virtual DbSet<tPreCotizacionDetalle> tPreCotizacionDetalles { get; set; }
        public virtual DbSet<tPreCotizacion> tPreCotizacions { get; set; }
        ...
        public virtual ObjectResult<string> PrecotizacionCotizacion(Nullable<int> idPreCotizacion)
        {
            var idPreCotizacionParameter = idPreCotizacion.HasValue ?
                new ObjectParameter("IdPreCotizacion", idPreCotizacion) :
                new ObjectParameter("IdPreCotizacion", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("PrecotizacionCotizacion", idPreCotizacionParameter);
        }
    
        public virtual ObjectResult<ReporteEstatusPrecotizaciones_Result> ReporteEstatusPrecotizaciones(Nullable<System.DateTime> fechaDesde, Nullable<System.DateTime> fechaHasta, string numeroPrecotizacion, string proyecto, Nullable<int> tipoCliente, Nullable<int> idCliente, Nullable<int> idVendedor)
        {
            ...
            var numeroPrecotizacionParameter = numeroPrecotizacion != null ?
                new ObjectParameter("NumeroPrecotizacion", numeroPrecotizacion) :
                new ObjectParameter("NumeroPrecotizacion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ReporteEstatusPrecotizaciones_Result>("ReporteEstatusPrecotizaciones", fechaDesdeParameter, fechaHastaParameter, numeroPrecotizacionParameter, proyectoParameter, tipoClienteParameter, idClienteParameter, idVendedorParameter);
        }
    
        public virtual ObjectResult<ReporteEstatusServicios_Result> ReporteEstatusServicios(Nullable<System.DateTime> fechaDesde, Nullable<System.DateTime> fechaHasta, string numeroPrecotizacion, Nullable<int> idServicio, Nullable<int> idProveedor)
        {
            var fechaDesdeParameter = fechaDesde.HasValue ?
                new ObjectParameter("FechaDesde", fechaDesde) :
                new ObjectParameter("FechaDesde", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ReporteEstatusServicios_Result>("ReporteEstatusServicios", fechaDesdeParameter, fechaHastaParameter, numeroPrecotizacionParameter, idServicioParameter, idProveedorParameter);
        }
    }
}
